        ...
        <div className="grid lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amal-gold focus:border-transparent outline-none transition-shadow"
                ...
                <div>
                  ...
                  <select
                    id="subject"
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amal-gold focus:border-transparent outline-none transition-shadow bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amal-gold focus:border-transparent outline-none transition-shadow resize-none"
                ...
                {/* File Upload Field */}
                <div>
                  <label htmlFor="file-upload" className="block text-sm font-medium text-slate-700 mb-1 flex items-center gap-2">
                    <Upload className="h-4 w-4" />
                    {text.attachLabel}
                  </label>
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-lg hover:border-amal-gold transition-colors bg-slate-50 group cursor-pointer relative">
                    <input 
                      id="file-upload" 
                      name="file-upload" 
                      type="file" 
                ...
                <button
                  type="submit"
                  className="w-full bg-amal-blue hover:bg-slate-800 text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-md hover:shadow-lg"
                >
                  {text.sendBtn}
                </button>
              </form>
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
              <div className="bg-blue-50 p-3 rounded-full text-amal-blue">
                <MapPin className="h-6 w-6" />
              </div>
              <div>
                <h3 className="font-bold text-lg text-slate-800 mb-1">{text.location}</h3>
                <p className="text-slate-600">123 Justice Avenue, Suite 400<br />Civil City, CC 90210</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg text-slate-800 mb-1">{text.emailUs}</h3>
                <p className="text-slate-600">contact@amal-center.org<br />press@amal-center.org</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg text-slate-800 mb-1">{text.callUs}</h3>
                <p className="text-slate-600">+1 (555) 123-4567<br />{text.hours}</p>
              </div>
            </div>

            {/* Map Placeholder */}
            <div className="bg-slate-200 rounded-2xl h-48 w-full flex items-center justify-center text-slate-500 text-sm">
              {text.mapPlaceholder}
            </div>
          </div>
        </div>
